...
ctx.canvas.addEventListener('mousemove' , function(event){
    ycoorD = event.clientX - ctx.canvas.offsetLeft;
    ycoorD = event.clientY - ctx.canvas.offsetTop;
    var temp = document.getElementById("mousePos");
    getCell(ycoorD , ycoorD);
    temp.innerHTML = ycoorD + "|" + ycoorD + "  Active Cell  : " + activeCell ;
});
